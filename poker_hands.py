...
def create_poker_hand_matrix():
    ...
    for i, r1 in enumerate(ranks):
        for j, r2 in enumerate(ranks):
            ...
            elif i > j and not (r1 in "T98765432" and r2 in "T98765432"):  # Remove low unpaired offsuit hands
...
def plot_hand_range(selected_hands, title="Basic Raise/Call/Fold Poker Hand Selection"):
    ...
    for i in range(13):
        for j in range(13):
            ...
            if hand:
                ...
                ax.text(j + 0.5, i + 0.5, hand, ha="center", va="center", fontsize=12, color="white")
    ...
    ax.legend(handles=legend_handles, loc="upper left", bbox_to_anchor=(1, 1), title="Action", fontsize=14)
